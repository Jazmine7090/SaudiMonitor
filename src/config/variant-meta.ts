...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  saudi: {
    ...
    keywords: 'Saudi Arabia news, GCC intelligence, Tadawul, TASI, ARAMCO, Vision 2030, NEOM, Gulf security, Saudi economy, Houthi threats, Yemen conflict, Saudi Arabia monitor, Gulf monitor, Saudi stocks, Saudi oil, Saudi energy, Riyadh, Jeddah, Gulf news, Middle East intelligence',
    url: 'https://saudi.worldmonitor.app/',
    siteName: 'Saudi Monitor',
    shortName: 'SaudiMonitor',
    subject: 'Saudi Arabia & Gulf Intelligence, Energy, Markets, and Security',
    classification: 'Regional Intelligence Dashboard, Gulf News Aggregator, Saudi Market Tracker',
    categories: ['news', 'finance'],
    features: [
      'Saudi Arabia & GCC news aggregation',
      'Tadawul (TASI) market tracking',
      'ARAMCO & Saudi energy data',
      'Yemen conflict & Houthi threat monitoring',
      'Vision 2030 progress tracking',
      'NEOM development updates',
      'Gulf security intelligence',
      'Saudi aviation & port monitoring',
      'Red Sea & Hormuz shipping data',
      'GCC economic indicators',
      'Saudi cyber threat monitoring',
